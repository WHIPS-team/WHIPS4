...
class HDFgome2l2_generic_filetype():
    parser = "HDFgome2l2"
    doutf = "OMNO2d_GOME2_netCDF_avg"
    parserParms = {}
    
class GOME2_NO2_KNMI_HDF_v2_3_filetype():
    parser = 'HDFgome2l2'
    parserParms = {}
    doutf = 'OMNO2d_GOME2_netCDF_avg'    
    overallQualFlag = 'fltrop'
    cloudFrac = 'clfrac' 
    ...
    outUnits = {   'a_lev' : 'Pa',
                   'b_lev' : 'Unitless',
                   'date' : 'yyyymmdd', # averaging date and time in this
                   'time' : 'hhmmss.f', # format over pixels is meaningless
                   'lon' : 'Degrees',
                   'lat' : 'Degrees',
                   'vcd' : 'Molecules cm^-2 x 10^-15',
                   'sigvcd' : 'Molecules cm^-2 x 10^-15',
                   'vcdtrop' : 'Molecules cm^-2 x 10^-15',
                   'sigvcdt' : 'Molecules cm^-2 x 10^-15',
                   'vcdstrat' : 'Molecules cm^-2 x 10^-15',
                   'sigvcds' : 'Molecules cm^-2 x 10^-15',
                   'fltrop' :  'Unitless',
                   'psurf' : 'Pa',
                   'sigvcdak' : 'Molecules cm^-2 x 10^-15',
                   'sigvcdtak' : 'Molecules cm^-2 x 10^-15',
                   'kernel' : 'Unitless',
                   'ghostcol' : 'Molecules cm^-2 x 10^-15',
                   'sza' : 'Degrees',
                   'vza' : 'Degrees',
                   'raa' : 'Degrees',
                   'ssc' : 'Unitless', # SCIAMACHY Subset Counter (??) 
                   'loncorn' : 'Degrees',
                   'latcorn' : 'Degrees',
                   'scd' : 'Molecules cm^-2 x 10^-15',
                   'amf' : 'Unitless',
                   'amftrop' : 'Unitless',
                   'amfgeo' : 'Unitless',
                   'scdstr' : 'Molecules cm^-2 x 10^-15',
                   'clfrac' : 'Unitless',
                   'cltpress' : 'Pa', # 1.3e4 corresponds to a tropopause cloud
                   'albclr' : 'Unitless',
                   'crfrac' : 'Unitless x 100', # in percent rather than frac
                   'ltropo' : 'Unitless'}
    
    extraDimLabel = {  'a_lev' : 'layer',
                       'b_lev' : 'layer',
                       'date' : 'none', 
                       'time' : 'none',
                       'lon' : 'none',
...
class OMI_NO2_KNMI_HDF_v2_0_postFeb2006_OMNO2d_filetype():
    parser = 'HDFknmiomil2'
    parserParms = {}
    doutf = 'OMNO2d_OMI_netCDF_avg'
    overallQualFlag = 'TroposphericColumnFlag'
    cloudFrac = 'CloudFraction'
    solarZenithAngle = 'SolarZenithAngle'
    time = 'Time'
